...
from src.modules.objectives import compute_irtr_recall
from src.gadgets.my_metrics import Accuracy, VQAScore, Scalar, F1_Score, AUROC, Scalar2, check
...
def epoch_wrapup(pl_module):
    ...
    if pl_module.hparams.config["get_recall_metric"] and not pl_module.training:
        ...
        print(11111111, (ir_r1, ir_r5, ir_r10, tr_r1, tr_r5, tr_r10), pl_module.global_step)
