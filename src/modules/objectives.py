...
def compute_food101(pl_module, batch):
    ...
    ####################################################################################
    # get the orthogonality_loss
    orthogonality_loss = infer.get("orthogonality_loss", 0.0)
    orth_loss_weight = 0.1
    weighted_orth_loss = orth_loss_weight * orthogonality_loss
    total_loss = imgcls_loss + weighted_orth_loss
    ####################################################################################

    ret = {
        "food101_loss": imgcls_loss,
        # "food101_loss": total_loss,
